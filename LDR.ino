...
Serial.println(int(colourArray[0]));
 ...
 else if(int(colourArray[1]) > int(colourArray[2]) && int(colourArray[1]) > int(colourArray[2])){
    Serial.print("G = ");
Serial.println(int(colourArray[1]));
    }
     else if(int(colourArray[2]) > int(colourArray[1]) && int(colourArray[2]) > int(colourArray[0])){
    Serial.print("B = ");
